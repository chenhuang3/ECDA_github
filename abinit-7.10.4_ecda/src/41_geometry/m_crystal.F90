...
!!
!! COPYRIGHT
!!  Copyright (C) 2008-2014 ABINIT group (MG, YP)
...
!!
!! PARENTS
!!      eig2tot,loper3,m_crystal_io,m_ddb,outscfcv,vtorho
!!
!! CHILDREN
...
!!
!! PARENTS
!!      anaddb,bethe_salpeter,eig2tot,loper3,m_wfs,mlwfovlp_qp,mrgscr,outscfcv
...
function isalchemical(Cryst) result(ans)
