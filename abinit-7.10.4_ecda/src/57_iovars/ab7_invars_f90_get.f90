! This file has been automatically generated, do not modify.
  ...
  subroutine ab7_invars_get_integer(dtsetsId, value, id, idtset, errno)
    ...
    case (ab7_invars_rf3elfd)
      value = token%dtsets(idtset)%rf3elfd
    case (ab7_invars_suskxcrs)
    ...
    case (ab7_invars_gw_reconst_scr)
    ...
    case (ab7_invars_gw_use_pole_scr)
    ...
    case (ab7_invars_gw_eet_inclvkb)
