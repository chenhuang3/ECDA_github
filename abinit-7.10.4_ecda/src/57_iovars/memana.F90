...
&     '  or increase limit on maximal array size.'
     ...
     if(option==1)then
       message = "option==1, cannot continue"
       MSG_ERROR(message)
     else
       quit=1
     end if
