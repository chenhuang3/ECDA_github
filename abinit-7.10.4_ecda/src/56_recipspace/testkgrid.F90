...
!!
!! NOTES
!! Note that nkpt can be computed by called this routine with input value of nkpt=0
...
!arrays
 ...
 real(dp),intent(inout) :: shiftk(3,8) !vz_i
...
&   '  For usual production runs, set prtkpt back to 0 (the default).'
   ...
   call leave_new('COLL',exit_status=0,print_config=.false.)
 end if
