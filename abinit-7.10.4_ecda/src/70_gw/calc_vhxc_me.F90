...
!!      pawcprj_destroy,rhohxc,wfd_change_ngfft,wfd_distribute_bbp,wfd_get_cprj
!!      wfd_get_ur,wrtout
!!
!! SOURCE
...
&  taug,taur) ! optional arguments
 ...
 use m_wfs,         only : wfd_get_ur, wfd_t, wfd_distribute_bbp, wfd_get_cprj, wfd_change_ngfft
...
&              Mels%vu      (ib,jb,ik_ibz,:) = DCMPLX(tmp_U(1,:),tmp_U(2,:))
   ...
   ABI_FREE(dimlmn)
   call pawcprj_destroy(Cprj_b1ks)
   ABI_DATATYPE_DEALLOCATE(Cprj_b1ks)
   call pawcprj_destroy(Cprj_b2ks)
