...
!!
!! CHILDREN
!!      cgpr,dotprod_vn,fftpac,fourdp,fourwf,ftfvw1__end,ftfvw1__init,laplacian
!!      mean_fftr,metric,mkffnl,nonlop,ph1d3d,rhotov,sphereboundary,timab
!!      xmpi_sum
!!
!! SOURCE
...
!End of the abilint section
 ...
 implicit none
  ...
  real(dp),intent(in) :: etotal,spinmagntarget,gsqcut
  ...
  real(dp) :: xredcp(3,natom),ylmgr_dum(1,1,1),znucl(1)
  real(dp) :: kpg_dum(0,0),dummyt2(0,0),dummyt3(0,0,0),dummy_lambda(1)
  real(dp),allocatable :: buffer(:),cwavef(:,:)
  real(dp),allocatable :: deltaW(:,:)
  real(dp),allocatable :: eig_k(:),ffnl(:,:,:,:),g2cart(:)
