...
!!
!! COPYRIGHT
!! Copyright (C) 2011-2014 ABINIT group (GG,MT)
...
!!      pimd_langevin_random_init,pimd_mass_spring,pimd_predict_taylor
!!      pimd_predict_verlet,pimd_print,pimd_stresses,xcart2xred,xred2xcart
!!
!! SOURCE
...
!scalars
 integer :: idum=-5
 integer :: iimage,irestart,ndof,pitransform,prtstress,zeroforce
...
!Compute stress tensor at t
 call pimd_stresses(mass,natom,quantummass,stress_pimd,stressin,thermtemp,trotter,vel,volume,xcart)
