...
!!
!! COPYRIGHT
!! Copyright (C) 2011-2014 ABINIT group (FJ,MT)
...
subroutine bandfft_kpt_init2(bandfft_kpt_in,dimffnl,ffnl_gather,ikpt_this_proc,kinpw_gather,kpg_k_gather,lmnmax,matblk,&
...
! *************************************************************************
 ...
 if (xcomm_size(spaceComm)<=1) return
