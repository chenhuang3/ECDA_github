...
!!      pawcprj_alloc,pawcprj_destroy,wfd_distribute_bbp,wfd_get_cprj,wrtout
...
&  inclvkb,lomo_spin,lomo_min,max_band,nkbz,qpoint,opt_cvk)
 ...
 use m_wfs,               only : wfd_t, wfd_get_cprj, wfd_distribute_bbp
...
#define ABI_FUNC 'calc_optical_mels'
 ...
 use interfaces_69_wfdesc, except_this_one => calc_optical_mels
