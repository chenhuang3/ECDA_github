...
!!
!! COPYRIGHT
!! Copyright (C) 2002-2014 ABINIT group (MVeithen, MB)
...
!!
!! CHILDREN
!!      d3output,d3sym,ebands_free,ebands_init,fourdp,getcut,getkgrid,getshell
!!      hdr_free,hdr_init,hdr_update,initmv,inwffil,ioarr,ioddb8_out,kpgio
!!      loop3dte,mkcore,nlopt,psddb8,pspini,rhohxc,setsym,setup1,status,symzat
!!      sytens,timab,wffclose,wrtout
!!
!! SOURCE
...
!scalars
 ...
 integer :: nkpt3,nkxc,nk3xc,nneigh,option,optorth,rdwr,rdwrpaw
...
&   nfft,pawrhoij,rdwr,rdwrpaw,wvl%den)
...
!  Call main output routine
   call d3output(blkflg,d3lo,dtset%mband,mpert,dtset%nkpt,dtset%natom,dtset%ntypat,dtfil%unddb)
