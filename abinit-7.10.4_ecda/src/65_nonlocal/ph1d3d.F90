...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2014 ABINIT group (XG,DR)
...
!!
!! PARENTS
!!      ctocprj,d2frnl,dens_in_sph,eltfrnl3,energy,forstrnps,getcprj,ks_ddiago
!!      ladielmt,lavnl,m_fock,m_shirley,m_wfs,nonlop_pl,nonlop_ylm,nstpaw3
!!      nstwf3,nstwf4,partial_dos_fractions,prctfvw1,prctfvw2,rhofermi3
