...
!!
!! COPYRIGHT
!! Copyright (C) 2005-2014 ABINIT group (JZ,MT)
...
!!
!! CHILDREN
!!      dsyev,free_my_atmtab,get_my_atmtab,gridgcart,make_efg_el,make_efg_ion
...
!Set up parallelism over atoms
 ...
 call make_efg_el(efg_el,gcart,natom,nfft,ngfft,nspden,nsym,paral_kgb,rhor,rprimd,symrel,tnons,xred)
