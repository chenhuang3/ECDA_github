...
& ee,dummy_out,gauss,gmet,gprimd,gresid,dummy_out,gsqcut,mgfft,&
& mqgrid,dtset%natom,nattyp,nfft,ngfft,ntypat,optatm,optdyfr,opteltfr,optgr,optn,optn2,optstr,optv,&
& pawtab,ph1d,qgrid,dummy3,dummy_in,dummy6,dummy6,ucvol,usepaw,vresg,vresg,vresg,dummy2,dummy_in,&
