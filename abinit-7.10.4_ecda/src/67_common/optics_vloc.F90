...
!!
!! COPYRIGHT
!! Copyright (C) 2010-2014 ABINIT group (SM,VR,FJ,MT)
...
!Local variables-------------------------------
!scalars
 integer :: accesswff,bdtot_index,cplex,etiq,fformopt,ib,icg,ierr,ikg,ikpt
 integer :: ipw,isppol,istwf_k,iwavef,jb,jwavef
 integer :: me,me_kpt,my_nspinor,nband_k,npw_k,sender
