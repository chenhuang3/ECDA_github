...
!!
!! COPYRIGHT
!!  Copyright (C) 2000-2013 ABINIT group (XG, MJV, MT, MG)
...
!!
!! PARENTS
!!      bonds_lgth_angles,fresid,ingeo,invars1,m_abi_etsf,m_abimover,m_atomdata
!!      m_crystal,m_crystal_io,mlwfovlp_setup,out1dm,prt_cif,prt_cml2
!!      prtfatbands,prtposcar,randomcellpos,recip_ylm,vdw_dftd2
!!      wvl_projectors_set
!!
!! CHILDREN
!!      atomdata_from_symbol,atomdata_from_znucl
!!
!! SOURCE
...
!!
!! PARENTS
!!      append_cml2,append_xyz,m_atomdata,upf2abinit,upfheader2abi
!!
!! CHILDREN
!!      atomdata_from_symbol,atomdata_from_znucl
!!
