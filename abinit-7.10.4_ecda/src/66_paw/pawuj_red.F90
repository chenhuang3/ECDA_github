...
!!
!! COPYRIGHT
!!  Copyright (C) 1998-2014 ABINIT group (DJA)
...
!!
!! CHILDREN
!!      free_my_atmtab,get_my_atmtab,linvmat,prmat,wrtout,xmpi_sum
!!
!! SOURCE
...
!  Reduction in case of parallelism
   if (paral_atom) then
     ...
     call xmpi_sum(atvshmusk,my_comm_atom,ierr) ! dim=natpawu ???
     call xmpi_sum(dmusk    ,my_comm_atom,ierr)
     call xmpi_sum(musk     ,my_comm_atom,ierr)
