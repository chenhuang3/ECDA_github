...
!!
!! COPYRIGHT
!! Copyright (C) 2008-2014 ABINIT group (MG,MT)
...
!!
!! PARENTS
!!      classify_bands,exc_plot,m_wfs,pawmkaewf,screening,sigma
!!
!! CHILDREN
!!
!! SOURCE
...
!scalars
 ...
 integer,optional,intent(in) :: optgrad,mpi_comm_atom
!arrays
...
&                    Paw_lmn_spline(itypat)%phi(:,inl),nfgd,nrm_sort,ff)
     ...
     if (my_optgrad==1) then
       ...
       call paw_spline(Pawrad(itypat)%rad,gg(:,1), mesh_size,ybcbeg,ybcend,&
