...
!!
!! COPYRIGHT
!! Copyright (C) 2001-2014 ABINIT group (DC)
...
module defs_wvltypes
 ...
 use BigDFT_API, only : atoms_data, locreg_descriptors, local_zone_descriptors, &
      & nonlocal_psp_descriptors, GPU_pointers, rho_descriptors, &
      & DFT_local_fields, DFT_wavefunction, energy_terms, &
      & rholoc_objects,gaussian_basis,paw_objects,coulomb_operator
#endif
...
type wvl_energy_terms
   !this is only for processors which do not support empty objects
