...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2014 ABINIT group (GZ, MT)
...
!!
!! PARENTS
!!      atm2fft,atm2fft3,dyfro3,forces,hartre,initro,pawmknhat,pawmknhat_psipsi
!!      prcref,prcref_PMA,stress,transgrid
!!
!! CHILDREN
!!
!! SOURCE
...
&                  ig1,ig2,ig3,mpi_comm_fft,distribfft) ! Optional arguments
...
!scalars
 ...
 integer,optional,intent(in) :: ig1,ig2,ig3,mpi_comm_fft
...
! **********************************************************************
 ...
 if (present(mpi_comm_fft)) then
   me_fft=xcomm_rank(mpi_comm_fft)
   nproc_fft=xcomm_size(mpi_comm_fft)
 end if
