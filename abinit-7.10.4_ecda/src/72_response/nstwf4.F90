...
!!
!! COPYRIGHT
!! Copyright (C) 1999-2014 ABINIT group (DRH, XG,AR,MB,MVer)
...
!!
!! CHILDREN
!!      dotprod_g,kpgstr,mkffnl,mkkin,nonlop,ph1d3d
!!
!! SOURCE
...
!scalars
 ...
 integer :: iband,ider,idir0,idir1,ilmn,ipert1
 integer :: ipw,ipws,ispinor,istr1,itypat,matblk
 integer :: me,n1,n2,n3,nkpg,nnlout,paw_opt,signs,tim_nonlop
 real(dp) :: arg,doti,dotr
!arrays
 real(dp) :: enlout(6),kpq(3)
 real(dp) :: dum_sij(1,1),dum_svectout(1,1),dum(1)
 ...
 real(dp),allocatable :: gvnl1(:,:),gvnlc(:,:),kinpw1(:)
 real(dp) :: kpg_dum(0,0)
...
&       natom,nattyp,1,ngfft,nkpg,nkpg,nloalg,nnlout,npw_k,npw1_k,nspinor,nspinor,&
...
!      but keep it as a test for now
       call dotprod_g(dotr,doti,istwf_k,npw1_k*nspinor,2,cwavef,gvnl1,mpi_enreg%me_g0,mpi_enreg%comm_spinorfft)
