...
MODULE m_gwdefs
 ...
 public :: use_wfk_file
 logical,public :: gw_uses_wfk_file=.FALSE.
...
! their names and unit numbers are not defined in the Dtfil% structure.
 ...
 integer,public,parameter :: unt_gwdiag  = 687 ! GW diagonal
...
subroutine use_wfk_file(useit)


!This section has been created automatically by the script Abilint (TD).
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'use_wfk_file'
!End of the abilint section

 logical,intent(in) :: useit

 gw_uses_wfk_file = useit        

end subroutine use_wfk_file
