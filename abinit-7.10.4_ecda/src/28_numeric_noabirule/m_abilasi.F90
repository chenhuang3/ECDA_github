...
!!
!! COPYRIGHT
!! Copyright (C) 1992-2014 ABINIT group (MG)
...
!************************************************************************
 ...
 ABI_CHECK_ALLOC('wrap_CHEEV: out of memory1')
      
 ABI_MALLOC(rwork,(MAX(1,3*n-2)))
 ABI_CHECK_ALLOC('wrap_CHEEV: out of memory2')
...
!************************************************************************
 ...
 CASE (.FALSE.)
  ...
  ABI_MALLOC(work,(lwork))
  ABI_CHECK_ALLOC('wrap_ZHEEV: out of memory1')

  ABI_MALLOC(rwork,(MAX(1,3*n-2)))
  ABI_CHECK_ALLOC('wrap_ZHEEV: out of memory2')
...
!************************************************************************
 ...
 CASE (.FALSE.)
  ...
  if (cplex==1) then  ! Real symmetric case.
   ...
   ABI_CHECK_ALLOC("wrap_DSYEV_ZHEEV: out of memory1!")
...
&    info," off-diagonal elements of an intermediate tridiagonal form did not converge to zero. "
   ...
   ABI_CHECK_ALLOC('wrap_DSYEV_ZHEEV: out of memory!')
...
!************************************************************************
 ...
 ABI_CHECK_ALLOC('wrap_CHPEV: out of memory1')

 ABI_MALLOC(rwork,(MAX(1,3*n-2)))
 ABI_CHECK_ALLOC('wrap_CHPEV: out of memory2')
...
!************************************************************************
 ...
 CASE (.FALSE.)
  ...
  ABI_MALLOC(work,(MAX(1,2*n-1)))
  ABI_CHECK_ALLOC('wrap_ZHPEV: out of memory1!')

  ABI_MALLOC(rwork,(MAX(1,3*n-2)))
  ABI_CHECK_ALLOC('wrap_ZHPEV: out of memory2!')
...
!************************************************************************
 ...
 CASE (.FALSE.)
  ...
  ABI_MALLOC(work,(lwork))
  ABI_CHECK_ALLOC('wrap_ZHEGV: out of memory1!')

  ABI_MALLOC(rwork,(MAX(1,3*n-2)))
  ABI_CHECK_ALLOC('wrap_ZHEGV: out of memory2!')
...
!************************************************************************
 ...
 CASE (.FALSE.)
  ...
  if (cplex==1) then ! Real symmetric case.
   ...
   ABI_MALLOC(work_real,(lwork))
   ABI_CHECK_ALLOC('wrap_DSYGV_ZHEGV 2: out of memory!')
...
&    "The factorization of B could not be completed and no eigenvalues or eigenvectors were computed."
   ...
   ABI_MALLOC(work_cplx,(lwork))
   ABI_CHECK_ALLOC('wrap_DSYGV_ZHEGV 2: out of memory1!')

   ABI_MALLOC(rwork,(MAX(1,3*n-2)))
   ABI_CHECK_ALLOC('wrap_DSYGV_ZHEGV 2: out of memory2!')
...
!************************************************************************
 ...
 CASE (.FALSE.) ! Standard LAPACK call.
  ...
  ABI_MALLOC(work,(lwork))
  ABI_CHECK_ALLOC('wrap_ZHEEVX: out of memory1!')

  ABI_MALLOC(rwork,(7*n))
  ABI_CHECK_ALLOC('wrap_ZHEEVX: out of memory2!')

  ABI_MALLOC(iwork,(5*n))
  ABI_CHECK_ALLOC('wrap_ZHEEVX: out of memory3!')

  ABI_MALLOC(ifail,(n))
  ABI_CHECK_ALLOC('wrap_ZHEEVX: out of memory4!')
...
!************************************************************************
 ...
 CASE (.FALSE.) ! Standard LAPACK call.
  ...
  if (cplex==1) then      ! Real symmetric case
   ...
   ABI_MALLOC(work_real,(lwork))
   ABI_CHECK_ALLOC('wrap_DSYEVX_ZHEEVX: out of memory1!')

   ABI_MALLOC(iwork,(5*n))
   ABI_CHECK_ALLOC('wrap_DSYEVX_ZHEEVX: out of memory2!')

   ABI_MALLOC(ifail,(n))
   ABI_CHECK_ALLOC('wrap_DSYEVX_ZHEEVX: out of memory3!')
...
&    info,"eigenvectors failed to converge. "
   ...
   ABI_MALLOC(ifail,(n))
   ABI_CHECK_ALLOC('wrap_DSYEVX_ZHEEVX: out of memory4!')
...
!************************************************************************
 ...
 CASE (.FALSE.) ! Standard LAPACK call.
  ...
  ABI_MALLOC(work,(lwork))
  ABI_CHECK_ALLOC('wrap_ZHEGVX: out of memory1!')

  ABI_MALLOC(rwork,(7*n))
  ABI_CHECK_ALLOC('wrap_ZHEGVX: out of memory2!')

  ABI_MALLOC(iwork,(5*n))
  ABI_CHECK_ALLOC('wrap_ZHEGVX: out of memory3!')

  ABI_MALLOC(ifail,(n))
  ABI_CHECK_ALLOC('wrap_ZHEGVX: out of memory4!')
...
!************************************************************************
 ...
 CASE (.FALSE.) ! Standard LAPACK call.
  ...
  if (cplex==1) then  ! Real symmetric case 
   ...
   ABI_MALLOC(work_real,(lwork))
   ABI_CHECK_ALLOC('wrap_DSYGVX_ZHEGVX 2: out of memory1!')

   ABI_MALLOC(iwork,(5*n))
   ABI_CHECK_ALLOC('wrap_DSYGVX_ZHEGVX 2: out of memory2!')

   ABI_MALLOC(ifail,(n))
   ABI_CHECK_ALLOC('wrap_DSYGVX_ZHEGVX 2: out of memory3!')
...
&    " The factorization of B could not be completed and no eigenvalues or eigenvectors were computed."
   ...
   ABI_MALLOC(ifail,(n))
   ABI_CHECK_ALLOC('wrap_DSYGVX_ZHEGVX 2: out of memory4!')
...
!************************************************************************
 ...
 ABI_MALLOC(work,(lwork))
 ABI_CHECK_ALLOC('wrap_CGEEV 1: out of memory1')

 ABI_MALLOC(rwork,(2*n))
 ABI_CHECK_ALLOC('wrap_CGEEV 1: out of memory2')
...
!************************************************************************
 ...
 CASE (.FALSE.)
  ...
  ABI_MALLOC(work,(lwork))
  ABI_CHECK_ALLOC('wrap_ZGEEV 1: out of memory1!')

  ABI_MALLOC(rwork,(2*n))
  ABI_CHECK_ALLOC('wrap_ZGEEV 1: out of memory2!')
...
! *************************************************************************
 ...
 if (do_check) then
   ...
   !call xginv(cmat_dpc_check,msize,comm=xmpi_self)
 end if
