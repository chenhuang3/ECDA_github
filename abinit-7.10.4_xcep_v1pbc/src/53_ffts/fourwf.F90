...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2014 ABINIT group (DCA, XG, GMR, FF)
...
!!
!! PARENTS
!!      accrho3,dens_in_sph,fock_getghc,fock_updatecwaveocc,getgh1c,getghc
!!      ladielmt,lavnl,m_fft_prof,mkrho,mkrho3,mlwfovlp,overlap_wf,pawmkaewf
!!      pawsushat,posdoppler,prctfvw1,prctfvw2,prep_fourwf,resp3dte
!!      spin_current,susk,susk_dyn,susk_dyn_pgg,suskmm,suskmm_dyn,tddft,vtowfk
!!      wffile,wfread
!!
!! CHILDREN
