...
!!
!! COPYRIGHT
!!  Copyright (C) 2014 ABINIT group (JB)
...
!End of the abilint section
 ...
 type(bfield_type),intent(in),target :: dtbfield
...
!!  write(std_out,*) 'psps=',ab_scfcv_in%psps
 ...
 !call entropyDMFT_init(this%entropyDMFT,this%dtset,this%mpi_enreg%comm_cell,this%dtfil%filnam_ds(3),this%dtfil%filnam_ds(4)) ! Do something only if DMFT and dmft_entropy = 1
...
!!!  Should be changed if special parallelization.
 ...
 if ( this%dtset%dmft_entropy == 0 ) then
   call scfcv_scfcv(this,electronpositron,rhog,rhor,rprimd,xred,xred_old,conv_retcode)
 elseif ( this%dtset%dmft_entropy >=1 ) then
   call scfcv_runWEntropyDMFT(this,electronpositron,rhog,rhor,rprimd,xred,xred_old,conv_retcode)
 end if
...
subroutine scfcv_runWEntropyDMFT(this,electronpositron,rhog,rhor,rprimd,xred,xred_old,conv_retcode)
...
!End of the abilint section
 ...
 integer , intent(out)   :: conv_retcode
   ...
   call scfcv(this%atindx,this%atindx1,this%cg,this%cpus,this%dtbfield,this%dtefield,this%dtfil,this%dtpawuj,&
...
&    this%scf_history,this%symrec,this%taug,this%taur,this%wffnew,this%wffnow,this%wvl,xred,xred_old,this%ylm,this%ylmgr,&
&    conv_retcode)
