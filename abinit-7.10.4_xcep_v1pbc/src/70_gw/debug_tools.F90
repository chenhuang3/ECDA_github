...
!!      mkkpg,paw_symcprj,pawcprj_alloc,pawcprj_destroy,wfd_get_cprj,wfd_sym_ur
!!
!! SOURCE
...
subroutine paw_check_symcprj(Wfd,ik_bz,band,spin,sym_mode,Cryst,Kmesh,Psps,Pawtab,Pawang,Cprj_bz)
 ...
 use m_wfs,            only : wfd_t, wfd_get_cprj, kdata_init, kdata_free, kdata_t, wfd_sym_ur
...
&    0,Wfd%indlmn,istwf_k,Gdata%kg_k,kpg_k,k_bz,Wfd%lmnmax,matblk,Wfd%mgfft,Wfd%MPI_enreg,&
