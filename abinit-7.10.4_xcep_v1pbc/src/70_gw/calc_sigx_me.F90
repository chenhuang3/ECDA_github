...
!!
!! CHILDREN
!!      cwtime,destroy_paw_pwij,esymm_symmetrize_mels,findqg0,get_bz_item
!!      get_uug,gsph_fft_tabs,hermitianize,init_paw_pwij,littlegroup_print
!!      paw_cross_rho_tw_g,paw_rho_tw_g,paw_symcprj,pawcprj_alloc,pawcprj_copy
!!      pawcprj_destroy,pawmknhat_psipsi,rho_tw_g,rotate_fft_mesh
!!      sigma_distribute_bks,timab,wfd_change_ngfft,wfd_get_cprj
!!      wfd_get_many_ur,wfd_get_ur,wfd_paw_get_aeur,wfd_sym_ur,wrtout,xmpi_sum
!!
!! SOURCE
...
& prtvol,pawcross)
 ...
 use m_wfs,           only : wfd_t, wfd_get_ur, wfd_get_cprj, wfd_change_ngfft, wfd_paw_get_aeur, wfd_get_many_ur,&
&                            wfd_sym_ur
...
!scalars
 ...
 integer :: ik_bz,ik_ibz,isym_q,iq_bz,iq_ibz,spin,isym,jb,is_idx,iatom
...
!   end if
 ...
 do spin=1,nsppol
   ...
   ABI_MALLOC(wfr_bdgw,(gwx_nfftot*nspinor,ib1:ib2))
