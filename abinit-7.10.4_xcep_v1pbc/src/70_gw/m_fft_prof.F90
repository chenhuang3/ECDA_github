...
&  option_lob,Ftest%MPI_enreg%paral_kgb,symrel, unit=dev_null)
...
subroutine init_FFT_prof(Ftprof,test_name,nthreads,ncalls,ndat,cpu_time,wall_time,gflops,results)
...
! ********************************************************************* 
 ...
 if (Ftest%available==0) then
   call init_FFT_prof(Ftprof,test_name,0,0,0,zero,zero,zero)
   RETURN
 end if
 ...
 call init_FFT_prof(Ftprof,test_name,Ftest%nthreads,NCALLS_FOR_TEST,&
...
! ********************************************************************* 
 ...
 call init_FFT_prof(Ftprof,test_name,Ftest%nthreads,NCALLS_FOR_TEST,Ftest%ndat,&
...
&                        +g0(3)*(i3/DBLE(n3)) )
 ...
 call init_FFT_prof(Ftprof,test_name,Ftest%nthreads,NCALLS_FOR_TEST,ndat,&
&   cpu_time,wall_time,gflops,results=results)
