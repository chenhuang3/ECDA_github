...
!!
!! CHILDREN
!!      calc_coh,calc_wfwfg,destroy_paw_pwij,epsm1_symmetrizer
!!      esymm_symmetrize_mels,findqg0,get_bz_item,get_epsm1,get_gftt,get_uug
!!      gsph_fft_tabs,hermitianize,init_paw_pwij,littlegroup_print,paw_rho_tw_g
!!      paw_symcprj,pawcprj_alloc,pawcprj_copy,pawcprj_destroy,rho_tw_g
!!      rotate_fft_mesh,sigma_distribute_bks,timab,wfd_change_ngfft
!!      wfd_get_cprj,wfd_get_many_ur,wfd_get_ur,wfd_sym_ur,wrtout,xgemv
...
& Kmesh,Qmesh,Ltg_k,Pawtab,Pawang,Paw_pwff,Psps,Wfd,allQP_sym,gwc_ngfft,accesswff,prtvol,sigcme_tmp)
 ...
 use m_wfs,           only : wfd_get_ur, wfd_t, wfd_get_cprj, wfd_change_ngfft, wfd_get_many_ur, wfd_sym_ur
...
!Arguments ------------------------------------
!scalars
 integer,intent(in) :: sigmak_ibz,ikcalc,prtvol,accesswff,nomega_sigc,minbnd,maxbnd
...
!   end if
 ...
 ABI_MALLOC(epsm1_qbz,(Sigp%npwc,Sigp%npwc,1))
