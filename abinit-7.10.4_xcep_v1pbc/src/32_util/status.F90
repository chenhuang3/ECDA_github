...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2014 ABINIT group (XG,TD)
...
!!
!! PARENTS
!!      abinit,accrho3,cgwf3,driver,getgh1c,getghc,gstate,gstateimg,loop3dte
!!      loper3,m_ab7_invars_f90,mover,mv_3dte,nonlinear,resp3dte,respfn
!!      rhofermi3,scfcv,scfcv3,suscep,vtorhotf,vtowfk3,wfkfermi3
!!
!! CHILDREN
!!      timab
!!
...
!arrays
 ...
 integer,save :: list_level(28)=&
&  (/1,2,100,101,102,110,111,112,113,114,10,11,12,13,14,15,16,17,18,20,30,31,40,41,50,51,52,90/)
 real(dp) :: tsec(2)
...
!    This level must be activated in order to have a corresponding output
     if(active(ilevel)==1 .or. active(ilevel)==2)then
       ...
       write(temp_unit,'(4a)')'  Level ',nm_levels(ilevel),' : ',nm_routine(ilevel)
