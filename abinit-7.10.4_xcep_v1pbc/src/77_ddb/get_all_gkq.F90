...
!scalars
 integer :: iost
 integer :: me,sz2,sz3,sz4,sz5,sz6
...
& ' get_all_gkq : gkq file/array size = ',&
 ...
 if (elph_ds%gkqwrite == 0) then !calculate gkk(q) keeping all in memory
   ...
   ABI_CHECK_ALLOC('Trying to allocate array elph_ds%gkk_qpt')
...
!=====================================================
 ...
 ABI_ALLOCATE(gkk_flag,(sz2,sz2,sz3,sz4,sz5))
 ABI_CHECK_ALLOC("allocating gkk_flag")
