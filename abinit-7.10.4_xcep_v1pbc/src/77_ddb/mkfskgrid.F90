...
! *************************************************************************
 ...
 ABI_CHECK_ALLOC("allocating tmpkphon_full2irr")
 tmpkphon_full2irr = -1
...
!also reorder tmpkphon_full2irr
 ...
 ABI_CHECK_ALLOC('allocating elph_k%kpt')

 ABI_ALLOCATE(elph_k%full2irr,(3,elph_k%nkpt))
 ABI_CHECK_ALLOC('allocating kphon_full2irr')

 ABI_ALLOCATE(sortindexing,(elph_k%nkpt))
 ABI_CHECK_ALLOC('allocating sortindexing')
...
!find correspondence table between irred FS kpoints and a full one
 ...
 ABI_CHECK_ALLOC('allocating elph_k%kphon_irr2full')
 elph_k%irr2full(:) = 0
...
!find correspondence table between FS kpoints under symmetry
 ...
 ABI_CHECK_ALLOC('in allocating kphon_full2full')
