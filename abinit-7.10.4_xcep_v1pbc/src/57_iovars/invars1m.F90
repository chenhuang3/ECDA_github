...
!!
!! COPYRIGHT
!! Copyright (C) 1999-2014 ABINIT group (XG, MKV)
...
!Arguments ------------------------------------
!scalars
 integer,intent(in) :: iout,lenstr,msym,mxnatom,ndtset,ndtset_alloc,npsp
...
!Local variables-------------------------------
!scalars
 integer :: idtset,ii,jdtset,lpawu,mband_upper,iatom !i1,
