...
!Also, if prtvol=-1 and NC file has been creates, only print one dataset
 ...
 intarr(1,:)=dtsets(:)%optfreqsus
 call prttagm(dprarr,intarr,iout,jdtset_,2,marr,1,narrm,ncid,ndtset_alloc,'optfreqsus','INT',0)
...
!upawu
 ...
 call prttagm(dprarr,intarr,iout,jdtset_,1,marr,narr,&
& narrm,ncid,ndtset_alloc,'upawu','ENE',multivals%ntypat)
