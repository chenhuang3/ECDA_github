...
!!
!! CHILDREN
!!      create_nc_file,etsf_io_low_close,outvar_a_h,outvar_i_n,outvar_o_z
!!      wrtout
!!
!! SOURCE
...
&   '-   accesswff0 =',dtsets(0)%accesswff,' , fftalg0 =',dtsets(0)%ngfft(7),' , wfoptalg0 =',dtsets(0)%wfoptalg,ch10,&
&   '-'
