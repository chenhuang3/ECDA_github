...
!!
!! COPYRIGHT
!! Copyright (C) 1992-2014 ABINIT group (MG, MT, XG, DCA, GZ, FB)
...
!!
!! PARENTS
!!      cgwf,cgwf3,corrmetalwf1,dfpt_write_cg,lapackprof,mkrho3,vtowfk3
!!
!! CHILDREN
!!      timab,xmpi_sum
!!
...
!!
!! PARENTS
!!      cgwf,cgwf3,chebfi,corrmetalwf1,eig2stern,extrapwf,mkresi,nonlop_gpu
!!      nstpaw3,nstwf3,nstwf4,recip_ylm,vtowfk3,wfkfermi3
!!
!! CHILDREN
!!      timab,xmpi_sum
!!
...
!MPIWF reduction (addition) on norm2 is needed here
 if(present(mpi_comm_sphgrid)) then
   nproc_sphgrid=xcomm_size(mpi_comm_sphgrid)
...
!!
!! PARENTS
!!      cgwf,cgwf3,getdc1,lapackprof,nstpaw3
!!
!! CHILDREN
!!      timab,xmpi_sum
!!
...
!scalars
 ...
 real(dp) :: cutoff,fcut,gs,gsq,kpgsqc 
 !character(len=500) :: msg
!arrays
