...
!!
!! COPYRIGHT
!! Copyright (C) 2008-2014 ABINIT group (MG, GMR, MJV, XG, MVeithen)
...
!!  of Numerical Recipies. The program returns values for the M fit parameters par, and chi-square. 
...
!!
!! PARENTS
!!      eliashberg_1d,evdw_wannier,exc_spectra,kramerskronig,m_ebands,m_gamma
!!      m_numeric_tools,m_phonons,m_xc_vdw,mka2f,mka2fQgrid,mka2f_tr
!!      mka2f_tr_lova,mlwfovlp_projpaw,mlwfovlp_radial,radsintr
!!
!! CHILDREN
!!      simpson_int
!!
...
!-----------------------------------------------------------------
 ...
 coef1 = 0.375_dp                          !9.0_dp  / 24.0_dp
 coef2 = 1.166666666666666666666666667_dp  !28.0_dp / 24.0_dp
 coef3 = 0.958333333333333333333333333_dp  !23.0_dp / 24.0_dp
