...
!!
!! PARENTS
!!      atomden,cpdrv,critics,denfgr,finddistrproc,get_g_tiny,invacuum,listkk
!!      m_bz_mesh,m_chi0,m_exc_diago,m_gsphere,m_ifc,m_paw_pwaves_lmn,m_screen
!!      m_tetrahedron,m_use_ga,m_vcoul,mkcore_inner,mlwfovlp_qp,mrgscr
!!      partial_dos_fractions,shellstruct,symkpt,tddft,thmeig,wffile,wvl_initro
!!
!! CHILDREN
!!
!! SOURCE
