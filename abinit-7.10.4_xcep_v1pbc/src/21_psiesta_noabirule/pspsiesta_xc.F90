...
! Next line is nonstandard but may be suppressed

!This section has been created automatically by the script Abilint (TD).
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'atomxc'
 use interfaces_21_psiesta_noabirule, except_this_one => atomxc
...
! jjunquer: we assume that we are not using the mixing of the functionals
      integer, parameter      :: MaxFunc = 1
...
! mspin : must be equal or larger than nspin (4 for non-collinear spin)
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'GGAXC'
 use interfaces_21_psiesta_noabirule, except_this_one => GGAXC
!End of the abilint section
...
! Note: D(1)=D11, D(2)=D22, D(3)=Real(D12), D(4)=Im(D12)
        ...
        CP = COS(PHI)
        SP = SIN(PHI)
! Find diagonal elements of the gradient
        DO IX = 1,3
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'LDAXC'
 use interfaces_21_psiesta_noabirule, except_this_one => LDAXC
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'PBEXC'
 use interfaces_21_psiesta_noabirule, except_this_one => PBEXC
!End of the abilint section
...
! Written by E. Artacho in January 2006 by modifying the PBE routine of 
! L.C.Balbas and J.M.Soler. December 1996. Version 0.5.
! ******** INPUT ******************************************************
! INTEGER IREL           : Relativistic-exchange switch (0=No, 1=Yes)
! INTEGER nspin          : Number of spin polarizations (1 or 2)
! REAL*8  Dens(nspin)    : Total electron density (if nspin=1) or
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'REVPBEXC'
 use interfaces_21_psiesta_noabirule, except_this_one => REVPBEXC
!End of the abilint section
...
! Fix some more numerical constants
      ...
      GAMMA = (1 - LOG(TWO)) / PI**2
      MU = BETA * PI**2 / 3
!ea  The only modification w.r.t. PBE in this following line.
      KAPPA = 1.245D0
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'PW91XC'
 use interfaces_21_psiesta_noabirule, except_this_one => PW91XC
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'PW92XC'
 use interfaces_21_psiesta_noabirule, except_this_one => PW92XC
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'RPBEXC'
 use interfaces_21_psiesta_noabirule, except_this_one => RPBEXC
!End of the abilint section
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'WCXC'
 use interfaces_21_psiesta_noabirule, except_this_one => WCXC
!End of the abilint section
...
! Written by L.C.Balbas and J.M.Soler for PBE. December 1996. 
...
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'PBESOLXC'
 use interfaces_21_psiesta_noabirule, except_this_one => PBESOLXC
!End of the abilint section
