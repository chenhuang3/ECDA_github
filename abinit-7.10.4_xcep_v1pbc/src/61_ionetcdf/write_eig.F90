...
!1. Create netCDF file
 ...
 NCF_CHECK(ncerr," create netcdf EIG file")
...
!2. Define dimensions
 ...
 NCF_CHECK(ncerr," define dimension mband")

 ncerr = nf90_def_dim(ncid,"nkpt",nkpt,nkpt_id)
 NCF_CHECK(ncerr," define dimension nkpt")
...
&   start = start2,&
&   count = count2)
   NCF_CHECK(ncerr," write variable kptns")
 end do
...
&     start = start3,&
&     count = count3)
     NCF_CHECK(ncerr," write variable band")
...
&     nbk,&
&     start = start2)
     NCF_CHECK(ncerr," write variable nband")
   end do
 end do
...
!7 Close file
 ...
 NCF_CHECK(ncerr," close netcdf EIG file")
#endif
