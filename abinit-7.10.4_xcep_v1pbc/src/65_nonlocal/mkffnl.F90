...
!!
!! PARENTS
!!      ctocprj,d2frnl,energy,forstrnps,ks_ddiago,ladielmt,lavnl
!!      m_commutator_vkbr,m_shirley,m_wfs,nstpaw3,nstwf3,nstwf4,prctfvw1
!!      prctfvw2,resp3dte,rhofermi3,vtorho,vtorho3
!!
!! CHILDREN
!!      mkkin,splfit,timab
!!
...
!$OMP END DO
!$OMP WORKSHARE
                 ffnl(:,4+mu,iffnl,itypat)=dffnl_tmp(:)
!$OMP END WORKSHARE
!$OMP END PARALLEL
               end do
             end if
