...
!!
!! COPYRIGHT
!!  Copyright (C) 2006-2014 ABINIT group (MVerstraete,MG)
...
!Xcrysden uses aperiodical data-grid
 ...
 call mkkptrank (kptirred,nkptirred,kptrank_t,nsymfm,symrecfm)
...
&         'kpt = ',kpt,ch10,' with rank ', symkptrank, ch10,&
