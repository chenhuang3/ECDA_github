...
!!
!! COPYRIGHT
!! Copyright (C) 2002-2014 ABINIT group
!!
!! INPUTS
!!
!! OUTPUT
...
!!
!! PARENTS
!!      afterscfloop,calc_vhxc_me,energy,ftfvw1,m_kxc,nonlinear,nres2vres
!!      odamix,prcref,prcref_PMA,prctfvw2,respfn,rhotov,scfcv,setvtr
!!
!! CHILDREN
!!
!! SOURCE
