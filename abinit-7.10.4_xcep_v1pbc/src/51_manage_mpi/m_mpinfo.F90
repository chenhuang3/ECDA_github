...
!!
!! COPYRIGHT
!!  Copyright (C) 2008-2013 ABINIT group (MT, GG)
...
!Initialize MPI
 ...
 mpi_enreg%me = xcomm_rank(xmpi_world)
 mpi_enreg%nproc = xcomm_size(xmpi_world)
#endif
...
!!
!! PARENTS
!!      abinit,bethe_salpeter,bsepostproc,calc_vhxc_me,cut3d,debug_tools
!!      dieltcel,fftprof,inwffil,ks_ddiago,kss2wfk,lapackprof,linear_optics_paw
!!      m_fft,m_fft_prof,m_fftcore,m_gsphere,m_hamiltonian,m_io_kss,m_kxc
!!      m_paw_pwij,m_ppmodel,m_screening,m_wfk,m_wfs,make_efg_el,mlwfovlp_qp
!!      mrgddb,mrggkk,mrgscr,optic,overlap_wf,scfcv,screening,sigma,suscep_stat
!!      susk,suskmm,ujdet,vdw_kernelgen,wffile,wfread
!!
!! CHILDREN
!!      xcomm_free
!!
...
! *********************************************************************
 ...
 if (associated(mpi_enreg%distrb_hf)) then
...
!pointers
 ...
 if (associated(mpi_enreg1%distrb_hf)) then
...
!!
!! PARENTS
!!      eltfrhar3,eltfrloc3,fftpac,fourdp,hartre,hartrestr
!!      indirect_parallel_Fourier,initro,laplacian,mag_constr,mkcore,mkcore_paw
!!      mklocl_realspace,mklocl_recipspace,moddiel,prcrskerker2,strhar,symrhg
!!      vloca3,vlocalstr,xcden,xcpot
!!
!! CHILDREN
!!      xcomm_free
!!
