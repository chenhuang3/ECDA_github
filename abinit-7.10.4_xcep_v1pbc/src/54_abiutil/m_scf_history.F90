...
MODULE m_scf_history
 ...
 use m_pawrhoij, only : pawrhoij_type, pawrhoij_nullify, pawrhoij_destroy
...
!************************************************************************
 ...
 if (allocated(scf_history%pawrhoij_last)) then
   call pawrhoij_destroy(scf_history%pawrhoij_last)
