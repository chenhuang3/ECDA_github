...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2014 ABINIT group (MF, XG).
...
&  gbound,gbound_diel,icg,ikpt,isp,istwf_k,kg_diel,kg_k,&
...
!scalars
 integer,intent(in) :: bdtot_index,extrap,icg,ikpt,isp,istwf_k,mband,mcg,mgfftdiel
...
!arrays
 ...
 integer,intent(in) :: kg_diel(3,npwdiel),kg_k(3,npw_k)
...
!scalars
 integer :: i1,i2,i3,iband,ibd1,ibd2,ifreq,ipw1,ipw2
