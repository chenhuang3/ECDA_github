...
!!
!! PARENTS
!!      fftprof,m_fft,m_fft_prof,memory_eval,mpi_setup,mrgscr,scfcv,suscep
!!
!! CHILDREN
...
subroutine getng(boxcutmin,ecut,gmet,kpt,me_fft,mgfft,nfft,ngfft,nproc_fft,nsym,option_lob,paral_fft,symrel,&
