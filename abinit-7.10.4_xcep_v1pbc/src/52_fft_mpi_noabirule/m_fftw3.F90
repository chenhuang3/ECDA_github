...
!!
!! COPYRIGHT
!! Copyright (C) 2009-2014 ABINIT group (MG, FD)
...
!!
!! CHILDREN
!!      dfftw_destroy_plan,dfftw_execute_dft,fill_cent,mpiswitch_cent,multpot
!!      scramble,switch_cent,switchreal_cent,timab,unfill_cent,unmpiswitch_cent
!!      unscramble,unswitch_cent,unswitchreal_cent,xmpi_ialltoall,xmpi_wait
!!
!! SOURCE
