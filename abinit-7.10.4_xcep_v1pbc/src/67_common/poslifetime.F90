...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2014 ABINIT group (GJ,MT,JW)
...
!!
!! OUTPUT
!!  gammastate_core= core annihilation rate needed for state dependent scheme for doppler broadening
...
!!
!! CHILDREN
!!      gammapositron,gammapositron_fft,mkdenpos,nderiv_gen,pawdensities,pawxcsum
!!      simp_gen,wrtout,xmpi_sum
!!
!! SOURCE
...
!scalars
 ...
 real(dp),intent(out) :: gammastate_core,rate,rate_paw
...
!  Set annihilation rate in proper unit (picosec.)
   ...
   gammastate_core=lambda_core/lambda_core_ipm
