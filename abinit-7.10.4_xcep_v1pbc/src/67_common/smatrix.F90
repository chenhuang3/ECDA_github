...
!!
!! COPYRIGHT
!! Copyright (C) 2000-2014 ABINIT  group (MVeithen)
...
!!
!! PARENTS
!!      berryphase_new,cgwf,getcgqphase,make_grad_berry,update_orbmag
!!
!! CHILDREN
...
!Local variables -------------------------
!scalars
 integer :: count,iband,info,ipw,ispinor,jband,jband1,jpw,pwmax,pwmin
...
!  magnetic field case, see update_orbmag.F90
