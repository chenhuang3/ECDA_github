...
!!
!! COPYRIGHT
!!   Copyright (C) 2005-2014 ABINIT group (JWZ)
...
!!
!! CHILDREN
!!      free_my_atmtab,get_my_atmtab,initylmr,nhatgrid,pawfgrtab_destroy
!!      pawfgrtab_init,pawrad_deducer0,printxsf,sort_dp,spline,splint,wrtout
!!      xmpi_barrier,xmpi_sum,xred2xcart
!!
!! SOURCE
...
!scalars
 ...
 integer :: klmn,master,my_comm_atom,my_start_indx,my_end_indx
...
!Note: call to nhatgrid: mpi_comm_fft not used because FFT parallelism
