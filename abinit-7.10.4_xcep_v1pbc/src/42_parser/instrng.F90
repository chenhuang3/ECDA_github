...
! input_unit=tmp_unit+100*include_level
! open (unit=input_unit,file=filnam,status='old',form='formatted')
...
!  End loop on iline. Note that there is an "exit" instruction in the loop
 ...
 write(msg,'(a,i6,3a)')'-instrng :',nline1,' lines of input have been read from file ',trim(filnam),ch10
