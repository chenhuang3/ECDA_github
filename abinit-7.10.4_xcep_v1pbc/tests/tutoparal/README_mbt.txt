...
First test: Generation of the KSS file 
 
Standard GS + NSCF calculation to produce the KSS file
...
9 k-points in the IBZ and the KSS generation does not support the paralkgb option. 

Also the number of bands in the KSS file is not enough to converge the GW 
...
then rename the KSS file

mv tmbt_1o_DS2_KSS 443_KSS
...
First create a symbolic link for the KSS file

ln -s 443_KSS tmbt_2i_KSS
...
First create two symbolic links for the KSS and the SCR file

ln -s 443_KSS     tmbt_4i_KSS
...
First create a symbolic link for the KSS and the SCR file

ln -s 443_KSS     tmbt_5i_KSS
