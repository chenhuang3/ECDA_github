...
!!
!! COPYRIGHT
!! Copyright (C) 1999-2014 ABINIT group (MG, GMR, VO, LR, RWG, MT)
...
!!
!! PARENTS
!!      m_gsphere,mrgscr,setup_bse,setup_bse_interp,setup_screening,setup_sigma
!!
!! CHILDREN
!!      gsph_free,gsph_init
!!
...
!!
!! PARENTS
!!      cchi0q0,setup_bse,setup_bse_interp
!!
!! CHILDREN
!!      gsph_free,gsph_init
!!
...
!!
!! PARENTS
!!      bethe_salpeter,cchi0,cchi0q0,check_completeness,m_gsphere,mrgscr
!!      screening,sigma
!!
!! CHILDREN
!!      gsph_free,gsph_init
...
!!
!! PARENTS
!!      setup_bse,setup_bse_interp,setup_sigma
!!
!! CHILDREN
!!      gsph_free,gsph_init
!!
...
&         new_Gsph%shlen(sh) /= in_Gsph%shlen(sh) ) then
       ierr = ierr + 1
