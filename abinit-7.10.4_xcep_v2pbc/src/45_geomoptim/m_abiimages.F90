...
!!****f* m_abiimages/abiimages_nullify
!! NAME
!! abiimages_nullify
!!
!! FUNCTION
!! Nullify all the pointers in a abimages object
!!
!! INPUTS
!!
!! OUTPUT
!!
!! SIDE EFFECTS
!!  images <type(abiimages)> = The abiimages to nullify
!!
!! PARENTS
!!
!! CHILDREN
...
subroutine abiimages_nullify(images)


!This section has been created automatically by the script Abilint (TD).
!Do not modify the following lines by hand.
#undef ABI_FUNC
#define ABI_FUNC 'abiimages_nullify'
!End of the abilint section
...
! ***************************************************************
 ...
 nullify(images%img_past)

end subroutine abiimages_nullify
!!***
