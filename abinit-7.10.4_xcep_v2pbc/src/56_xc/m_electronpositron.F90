...
!!
!! COPYRIGHT
!! Copyright (C) 2008-2014 ABINIT group (MT)
...
!!
!! CHILDREN
!!      energies_copy,fourdp,pawcprj_alloc,pawcprj_copy,pawcprj_destroy
!!      pawrhoij_alloc,pawrhoij_copy,pawrhoij_destroy
!!
!! SOURCE
...
!************************************************************************
 ...
 if (associated(electronpositron)) then
  ...
  if (electronpositron%has_pawrhoij_ep/=0) then
   call pawrhoij_destroy(electronpositron%pawrhoij_ep)
  end if
  ...
  if (electronpositron%dimcprj/=0) then
   call pawcprj_destroy(electronpositron%cprj_ep)
  end if
