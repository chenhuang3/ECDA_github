...
!!
!! COPYRIGHT
!! Copyright (C) 1999-2014 ABINIT group (MJV)
...
! allocate int
  ...
  ABI_CHECK_ALLOC('problem allocating pcell%indsym')
  ABI_ALLOCATE(pcell%symrec,(3,3,pcell%nsym))
  ABI_CHECK_ALLOC('problem allocating pcell%symrec')
  ABI_ALLOCATE(pcell%symrel,(3,3,pcell%nsym))
  ABI_CHECK_ALLOC('problem allocating pcell%symrel')
  ABI_ALLOCATE(pcell%typat,(pcell%natom))
  ABI_CHECK_ALLOC('problem allocating pcell%typat')

! allocate real
  ABI_ALLOCATE(pcell%acell,(3))
  ABI_CHECK_ALLOC('problem allocating pcell%acell')
  ABI_ALLOCATE(pcell%amu,(pcell%ntypat))
  ABI_CHECK_ALLOC('problem allocating pcell%amu')
  ABI_ALLOCATE(pcell%dielt,(3,3))
  ABI_CHECK_ALLOC('problem allocating pcell%dielt')
  ABI_ALLOCATE(pcell%dyewq0,(3,3,pcell%natom))
  ABI_CHECK_ALLOC('problem allocating pcell%dyewq0')
  ABI_ALLOCATE(pcell%gmet,(3,3))
  ABI_CHECK_ALLOC('problem allocating pcell%gmet')
  ABI_ALLOCATE(pcell%gprim,(3,3))
  ABI_CHECK_ALLOC('problem allocating pcell%gprim')
  ABI_ALLOCATE(pcell%rcan,(3,pcell%natom))
  ABI_CHECK_ALLOC('problem allocating pcell%rcan')
  ABI_ALLOCATE(pcell%rmet,(3,3))
  ABI_CHECK_ALLOC('problem allocating pcell%rmet')
  ABI_ALLOCATE(pcell%rprim,(3,3))
  ABI_CHECK_ALLOC('problem allocating pcell%rprim')
  ABI_ALLOCATE(pcell%rpt,(3,pcell%nrpt))
  ABI_CHECK_ALLOC('problem allocating pcell%rpt')
  ABI_ALLOCATE(pcell%trans,(3,pcell%natom))
  ABI_CHECK_ALLOC('problem allocating pcell%trans')
  ABI_ALLOCATE(pcell%wghatm,(pcell%natom,pcell%natom,pcell%nrpt))
  ABI_CHECK_ALLOC('problem allocating pcell%wghatm')
  ABI_ALLOCATE(pcell%xred,(3,pcell%natom))
  ABI_CHECK_ALLOC('problem allocating pcell%xred')
  ABI_ALLOCATE(pcell%zeff,(3,3,pcell%natom))
  ABI_CHECK_ALLOC('problem allocating pcell%zeff')
