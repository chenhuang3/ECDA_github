...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2014 ABINIT group (XG,AR,MB)
...
!!      pawcprj_destroy,pawcprj_diskinit_r,pawcprj_get,pawcprj_mpi_allgather
!!      pawcprj_nullify,pawgylmg,ph1d3d,sphereboundary,susk,suskmm,symg,symrhg
!!      timab,xmpi_sum,zhpev
!!
!! SOURCE
...
&  wtk,ylmdiel)
 ...
 use m_pawcprj, only : pawcprj_type, pawcprj_diskinit_r, pawcprj_alloc, &
&                      pawcprj_get, pawcprj_mpi_allgather, pawcprj_destroy, pawcprj_nullify
