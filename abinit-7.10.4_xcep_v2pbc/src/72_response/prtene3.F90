...
!!
!! COPYRIGHT
!! Copyright (C) 1999-2014 ABINIT group (XG, DRH)
...
&   (ipert==natom+2.and. (berryopt==4 .or. berryopt==6 .or. berryopt==7 .or. & 
&   berryopt==14 .or. berryopt==16 .or. berryopt==17) .and.usepaw==1).or. &
&   (ipert==natom+2.and. (berryopt/=4 .and. berryopt/=6 .and. berryopt/=7 .and. &
&   berryopt/=14 .and. berryopt/=16 .and. berryopt/=17).and.usepaw==1)) then
   numb='Eight'
 else if ( (ipert==natom+5.and.usepaw==0).or. &
&   (ipert==natom+2.and. (berryopt/=4 .and. berryopt/=6 .and. berryopt/=7 .and. &
&   berryopt/=14 .and. berryopt/=16 .and. berryopt/=17) .and.usepaw==0).or. &
&   (ipert==natom+2.and. (berryopt==4 .or. berryopt==6 .or. berryopt==7 .or. & 
&   berryopt==14 .or. berryopt==16 .or. berryopt==17) .and.usepaw==0) ) then
   numb='Seven'
 end if
...
&   ' the relaxation energy is the total one'
   if( berryopt == 4 .or. berryopt == 6 .or. berryopt == 7  &
&   .or. berryopt == 14 .or. berryopt == 16 .or. berryopt == 17)then
