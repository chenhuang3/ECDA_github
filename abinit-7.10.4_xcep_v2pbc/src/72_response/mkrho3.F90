...
!scalars
 ...
 integer :: ikg1,ikpt,ispden,ispinor,isppol,istwf_k
...
!arrays
 ...
 real(dp) :: tsec(2)
 real(dp),allocatable :: cwavef(:,:),cwavef1(:,:)
...
!call wrtout(std_out,'mkrho3: loop on k-points and spins done in parallel','COLL')
