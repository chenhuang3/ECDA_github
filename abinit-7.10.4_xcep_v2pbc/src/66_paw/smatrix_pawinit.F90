...
!!
!! COPYRIGHT
!! Copyright (C) 2005-2014 ABINIT group (T Rangel,BAmadon,FJollet,PHermet)
...
!!
!! CHILDREN
!!      initylmr,pawcprj_alloc,pawcprj_destroy,pawcprj_get,pawcprj_getdim,sbf8
!!      simp_gen
!!
!! SOURCE
...
& seed_name,typat,xred)
 ...
 use m_pawcprj, only : pawcprj_type, pawcprj_alloc, pawcprj_get, pawcprj_destroy, pawcprj_getdim
