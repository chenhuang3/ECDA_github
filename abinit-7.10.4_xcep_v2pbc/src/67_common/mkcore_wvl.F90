...
!!
!! CHILDREN
!!      ext_buffers,ind_positions,metric,mkcore_inner,mkdenpos,pawrad_destroy
...
& vxc,xccc3d,xred,mpi_comm_wvl)
 ...
 use m_xmpi,    only : xcomm_size,xmpi_sum
...
!mpi
 if(present(mpi_comm_wvl)) nproc_wvl=xcomm_size(mpi_comm_wvl)
