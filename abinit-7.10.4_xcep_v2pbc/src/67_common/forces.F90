...
!!
!! COPYRIGHT
!! Copyright (C) 1998-2013 ABINIT group (DCA, XG, GMR, FJ, MT)
...
!Arguments ------------------------------------
!scalars
 integer,intent(in) :: mgfft,n1xccc,n3xccc,nfft,ngrvdw,ntypat
...
!arrays
 ...
 real(dp) :: rmet(3,3),tsec(2),vprtrb_dum(2)
...
! allocate (unused) dummy variables, otherwise some compilers complain
   ...
   call atm2fft(atindx1,atmrho_dum,atmvloc_dum,dyfrn_dum,dyfrv_dum,eei_dum,&
&   eltfrn_dum,gauss_dum,gmet,gprimd,&
&   grxc,grl,gsqcut,mgfft,psps%mqgrid_vl,dtset%natom,nattyp,nfft,ngfft,ntypat,&
&   optatm,optdyfr,opteltfr,optgr,optn,optn2,optstr,optv,pawtab,ph1d,psps%qgrid_vl,qprtrb_dum,&
&   rhog,dummy6,dummy6,ucvol,psps%usepaw,vxctotg,vxctotg,vxctotg,vprtrb_dum,psps%vlspl,&
