...
!!
!! COPYRIGHT
!! Copyright (C) 2009-2014 ABINIT group (MG, MM)
...
!!
!! PARENTS
!!      m_fft,m_fft_prof,m_oscillators,m_paw_pwij,m_shirley
!!
!! CHILDREN
!!      fourwf_mpi
!!
...
& ], [6,NSETS] )
 ...
 nproc_fft = xcomm_size(comm_fft); me_fft = xcomm_rank(comm_fft)
 ...
 do iset=1,1 
   ...
   !call getng(boxcutmin,ecut,gmet,kpt,me_fft,mgfft,nfft,ngfft,nproc_fft,nsym,option_lob,paral_fft,symrel,&
   ...
   ngfft(11)=xcomm_rank(comm_fft)  ! me_fft
...
!Local variables-------------------------------
!scalars
 integer,parameter :: nsym1=1,option_lob2=2 
 integer,parameter :: npw0=0,cplex_one=1,istwfk_one=1
...
&    option_lob2,paral_kgb,symrel,unit=dev_null)
