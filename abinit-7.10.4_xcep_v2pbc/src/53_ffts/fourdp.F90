...
!!      dieltcel,dyfro3,eltfrxc3,energy,fock_getghc,forces,fourdp_6d,fresidrsp
!!      ftfvw1,ftfvw2,green_kernel,gstate,hartre,hartre1,hartrestr,initro
!!      jellium,ladielmt,laplacian,loop3dte,loper3,m_electronpositron
!!      m_fft_prof,m_hidecudarec,m_kxc,m_ppmodel,m_screening,make_efg_el
!!      mklocl_realspace,mklocl_recipspace,moddiel,moddiel_csrb,mrgscr,newrho
!!      newvtr,newvtr3,nonlinear,nres2vres,odamix,pawmknhat,pawmknhat_psipsi
!!      pawmkrho,posdoppler,prcref,prcref_PMA,prctfvw1,prctfvw2,prctfw3
!!      recursion,recursion_nl,redgr,respfn,rotate_rho,scfcv,scfcv3,screening
!!      setup_positron,sigma,stress,symrhg,tddft,transgrid,vloca3,vlocalstr
!!      xcden,xcpot
!!
!! CHILDREN
