...
!!
!! COPYRIGHT
!! Copyright (C) 2002-2014 ABINIT group (DCA, XG)
...
!!      m_bandfft_kpt,m_fft,m_fft_prof,m_fock,m_gsphere,m_wfs,mkrho,mkrho3
!!      mlwfovlp,nstpaw3,overlap_wf,pawmkaewf,posdoppler,prctfvw1,prctfvw2
!!      resp3dte,rhofermi3,scfcv,spin_current,suscep,suscep_dyn,suscep_stat
!!      susk,tddft,vtorho,vtorho3,wfconv,wffile,wfread
!!
!! CHILDREN
!!
!! SOURCE
