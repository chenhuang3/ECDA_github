...
!!
!! COPYRIGHT
!! Copyright (C) 2008-2014 ABINIT group (MG, GMR, VO, LR, RWG, YMN, RS)
...
MODULE m_fft_mesh
 ...
 !public :: new_setmesh        ! Perform the setup of the FFT mesh for the GW oscillator strengths.
...
!!      classify_bands,cohsex_me,m_wfs,prep_calc_ucrpa,screening
!!
!! CHILDREN
!!      xcopy
!!
...
pure function g2ifft(gg,ngfft) result (gidx)
