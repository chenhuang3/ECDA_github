...
& energies%e_ewald + energies%e_vdw_dftd2 + energies%e_corepsp
...
&   wvl%wfs%ks%orbs, wvl%wfs%ks%lzd%Glr, wvl%projectors%nlpspd, dtset%tl_nprccg, &
&   wvl%den%denspot%pot_work, dtset%wvl_hgrid, xcart, psps%gth_params%radii_cf, &
&   dtset%wvl_crmult, dtset%wvl_frmult, dtset%nsppol, &
&   wvl%projectors%proj, wvl%wfs%ks%psi, .false., ekin_sum, epot_sum, eproj_sum,&
