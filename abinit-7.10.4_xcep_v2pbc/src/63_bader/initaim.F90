...
!!
!! CHILDREN
!!      bschg1,hdr_comm,hdr_free,hdr_io,inspln,lubksb,ludcmp,metric,xmpi_bcast
!!
!! SOURCE
...
subroutine initaim(aim_dtset,znucl_batom)
 ...
 use m_header,  only : hdr_free, hdr_io, hdr_comm
...
!Local variables ------------------------------
!scalars
 integer :: fform0,id,ierr,ii,info,jj,kk,kod,mm,ndtmax,nn,nsa,nsb,nsc,nsym,rdwr,me,master,nproc,npsp
 integer :: unth,comm
...
!Echo part of the header
 rdwr=4
 call hdr_io(fform0,hdr,rdwr,std_out)
