...
!!
!! CHILDREN
!!      abi_xorthonormalize,getghc,lobpcgcciiiwf,nonlop,timab,xmpi_sum,zgemm
!!      zheev,zhegv,ztrsm
!!
!! SOURCE
...
!End of the abilint section
  ...
  integer :: maxiterations,my_nspinor,nkpg,nnlout,optekin,optpcon,paw_opt
...
&     vectsize,blockvectorx,vectsize,czero,gramyx,bblocksize)
     ...
     call xmpi_sum(gramyx,mpi_enreg%comm_fft,ierr)
...
&   vectsize,blockvectorax,vectsize,czero,gramxax,blocksize)
   call timab(48,1,tsec)
   call xmpi_sum(gramxax,mpi_enreg%comm_fft,ierr)
   call timab(48,2,tsec)
...
!    blockvectorr=blockvectorax-blockvectordumm
   ...
   call timab(48,1,tsec)
   call xmpi_sum(residualnorms,mpi_enreg%comm_fft,ierr)
   call timab(48,2,tsec)
