...
!!      fft_use_lib_threads,fftprof_ncalls_per_test,fftw3_init_threads
!!      flush_unit,get_kg,getng,herald,init_fft_test,initmpi_seq,lower,metric
!!      nullify_fft_test,print_fft_profs,print_fft_test,prof_fourdp,prof_fourwf
!!      prof_rhotwg,time_fftbox,time_fftu,time_fourdp,time_fourwf,time_rhotwg
!!      wrtout,xmpi_bcast,xmpi_init,xomp_show_info
!!
!! SOURCE
...
!scalars
 ...
 integer,parameter :: paral_kgb0=0,me_fft0=0,nproc_fft1=1,option_lob2=2,master=0
...
!1  continue
 ...
 do it=1,ntests
   call init_FFT_test(Ftest(it),fft_setups(:,it),kpoint,ecut,boxcutmin2,rprimd,nsym,symrel,MPI_enreg)
   ...
   if (it == 1) then
     call print_FFT_test(Ftest(it)) !,header) 
...
&     option_lob2,paral_kgb0,symrel,unit=dev_null)
