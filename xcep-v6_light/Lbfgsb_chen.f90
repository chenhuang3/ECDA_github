...
subroutine setulb(n, m, x, l, u, nbd, f, g, factr, pgtol, wa, iwa, & 
                  task, iprint,  csave, lsave, isave, dsave, time_start, myrank)
...
!! chen hack ===================
      real             :: time_start  ! chen: my parameter, keep track of the time elapsed in the iterations
!! chen hack ===================
...
!     ************
      ...
      call mainlb(n,m,x,l,u,nbd,f,g,factr,pgtol, &
       ...
       csave,lsave,isave(22),dsave,time_start,myrank)
...
!======================= The end of setulb =============================
      ...
      subroutine mainlb(n, m, x, l, u, nbd, f, g, factr, pgtol, ws, wy, &
                       ...
                       iprint, csave, lsave, isave, dsave, time_start, myrank)
 
      character*60     task, csave
      logical          lsave(4)
      integer          n, m, iprint, nbd(n), index(n),&
                      iwhere(n), indx2(n), isave(23), myrank
...
! quark8 666
          write(ssss,*)myrank
            fname='iterate_'//trim(adjustl(ssss))//'.dat'
            open (8, file = fname)
...
!quark8
         call prn2lb(n,x,f,g,iprint,itfile,iter,nfgv,nact, &
                    sbgnrm,nint,word,iword,iback,stp,xstep,time_start)
         goto 1000
      endif
 777  continue
...
!     Save local variables.
 ...
 1003 format (2(1x,i4),5x,'-',5x,'-',3x,'-',5x,'-',5x,'-',8x,'-',3x,1x,es10.3,1x,f16.10)
...
!      print *,'BFGS:  dot_prod(dir_bfgs,gradient):  ',gd
!      print *,'BFGS:  dot_prod(-gradient,gradient): ',ddot_lbfgsb(n,g,1,-g,1)
!      open(file='dir_lbfgs.dat',action='write',unit=111,form='unformatted')
!      write(111) d
!      close(111)
      if (ifun .eq. 0) then
         gdold=gd
...
!quark8
 ...
 9001 format (/,3x,'it',3x,'nf',2x,'nint',2x,'nact',2x,'sub',2x,'itls', &
             2x,'stepl',4x,'tstep',5x,'projg',8x,'   f',12x,' t')
...
! chen =================================================
      integer, dimension(3) :: tarray
      real :: current_time, elap_time, time_start
! ======================================================      
...
! chen --------------------------------------------------
      ...
      !print *, tarray(2)
      !print *, tarray(3)
      current_time = tarray(1)*60.d0*60.d0 + &
                     tarray(2)*60.d0 + tarray(3)
      elap_time = current_time - time_start
!      print *,''
...
! chen --------------------------------------------------
      ...
      if (iprint .ge. 1) then 
       write (itfile,3001) & 
       iter,nfgv,nint,nact,word,iback,stp,xstep,sbgnrm,f,elap_time
       call flush(itfile)
      endif 
...
!! this is printed for each iteraction with NEW_X flag        
! 3001 format(2(1x,i4),2(1x,i5),2x,a3,1x,i4,1p, & 
!             2(2x,d7.1),1p,1x,d10.3,1x,d17.10,f12.2)
 3001 format(2(1x,i4),2(1x,i5),2x,a3,1x,i4, & 
             2(2x,es8.1),1x,es10.3,1x,f16.10,f9.2)
