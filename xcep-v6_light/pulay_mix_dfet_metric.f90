...
subroutine pulay_mix_dfet_metric(n1,n2,n3,npt,iopt,uemb,uemb_new,work,npulay,pulay_beta, & 
 ...
 call precond_dfet(n1,n2,n3,n1*n2*n3,qvec,zp_alpha,zp_eta,uemb_new-uemb,resid)

 work(:,npulay,1) = resid ! store new residual 
