...
subroutine setulb(n, m, x, l, u, nbd, f, g, factr, pgtol, wa, iwa,   task, iprint,  csave, lsave, isave, dsave, time_start)
...
!! chen hack ===================
      real             :: time_start  ! chen: my parameter, 
                                      ! keep track of the time elapsed in the iterations
!! chen hack ===================
...
!     ************
      ...
      call mainlb(n,m,x,l,u,nbd,f,g,factr,pgtol, &
       ...
       csave,lsave,isave(22),dsave,time_start)
...
!======================= The end of setulb =============================
      ...
      subroutine mainlb(n, m, x, l, u, nbd, f, g, factr, pgtol, ws, wy, &
                       ...
                       iprint, csave, lsave, isave, dsave, time_start)
...
!             2(2x,d7.1),1p,1x,d10.3,1x,d17.10,f12.2)
 3001 format(2(1x,i4),2(1x,i5),2x,a3,1x,i4, & 
             2(2x,es7.1),1x,es10.3,1x,f16.10,f9.2)
