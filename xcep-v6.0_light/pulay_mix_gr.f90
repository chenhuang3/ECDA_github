...
subroutine pulay_mix_gr(task,npt,iwork,uemb,uemb_new,work,npulay,pulay_beta)
 ...
 if (task(1:7)=='NEW_RES') then 
   ...
   uemb_new = 0.d0
   do ii=1,neff
     uemb_new = uemb_new + work(:,npulay-neff+ii,2)*pulay_matrix(ii,neff+1)
   enddo
