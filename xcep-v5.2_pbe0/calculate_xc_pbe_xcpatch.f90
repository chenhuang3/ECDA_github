...
subroutine calculate_xc_pbe_xcpatch(n1,n2,n3,nspin,rho,qvec,dvol,xc_pot,xc_energy,xc_density)
     ...
     real(kind=8) :: xc_energy, xc_density(n1*n2*n3)
...
!======================================function body=====================================
  ...
  !   write(*,*) "USING NEW SPIN LIBXC!!!!"
     ...
     xc_density = reshape(rhotot*excpbe,(/n1*n2*n3/))
...
end subroutine calculate_xc_pbe_xcpatch
